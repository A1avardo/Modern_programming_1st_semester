...
const MVlad::MenuItem MVlad::TRAVEl_DV1 = {
	"1 - �����������",  MVlad::travel_dv1, &MVlad::TRAVEl_DV
};
const MVlad::MenuItem MVlad::TRAVEl_DV2 = {
	"2 - �������",  MVlad::travel_dv2, &MVlad::TRAVEl_DV
};
const MVlad::MenuItem MVlad::TRAVEl_DV3 = {
	"3 - ���������",  MVlad::travel_dv3, &MVlad::TRAVEl_DV
};
const MVlad::MenuItem MVlad::TRAVEl_DV_EXIT = {
	"0 - ����� � ���������� ����",  MVlad::travel_dv_exit, &MVlad::TRAVEl_DV
};
...
const MVlad::MenuItem MVlad::TRAVEl_DV = {
	"1 - ������� ������",  MVlad::show_menu, &MVlad::TRAVEl, travel_dv_children, travel_dv_size
};
const MVlad::MenuItem MVlad::TRAVEl_SIB = {
	"2 - �����",  MVlad::travel_sib, &MVlad::TRAVEl
};
const MVlad::MenuItem MVlad::TRAVEl_GOLDR= {
	"3 - ������� ������ ������",  MVlad::travel_goldr, &MVlad::TRAVEl
};
const MVlad::MenuItem MVlad::TRAVEl_GO_BACK = {
	"0 - ����� � �������� ����",  MVlad::travel_go_back, &MVlad::TRAVEl
};
...
namespace {
	...
	const MVlad::MenuItem MVlad::TRAVEl = {
		"1- �������������� �� ������", MVlad::show_menu, &MVlad::MAIN, travel_children, travel_size
	};

	const MVlad::MenuItem MVlad::EXIT = {
		"0 - ��������� �����������", MVlad::exit, &MVlad::MAIN
	};
